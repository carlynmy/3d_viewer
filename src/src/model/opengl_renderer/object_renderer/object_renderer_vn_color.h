// Declaration class ObjectRendererVNColor

#ifndef _3D_VIEWER_MODEL_OPENGL_RENDERER_OBJECT_RENDERER_OBJECT_RENDERER_VN_COLOR_H_
#define _3D_VIEWER_MODEL_OPENGL_RENDERER_OBJECT_RENDERER_OBJECT_RENDERER_VN_COLOR_H_
...
class ObjectRendererVNColor : public ObjectRendererColor {
 public:
  ObjectRendererVNColor();
  virtual ~ObjectRendererVNColor();
...
#endif  // _3D_VIEWER_MODEL_OPENGL_RENDERER_OBJECT_RENDERER_OBJECT_RENDERER_VN_COLOR_H_
