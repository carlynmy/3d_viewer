// Declaration class ObjectRendererVTNTexture

#ifndef _3D_VIEWER_MODEL_OPENGL_RENDERER_OBJECT_RENDERER_OBJECT_RENDERER_VTN_TEXTURE_H_
#define _3D_VIEWER_MODEL_OPENGL_RENDERER_OBJECT_RENDERER_OBJECT_RENDERER_VTN_TEXTURE_H_
...
class ObjectRendererVTNTexture : public ObjectRendererTexture {
 public:
  ObjectRendererVTNTexture();
  virtual ~ObjectRendererVTNTexture();
