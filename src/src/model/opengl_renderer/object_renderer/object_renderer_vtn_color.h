// Declaration class ObjectRendererVTNColor

#ifndef _3D_VIEWER_MODEL_OPENGL_RENDERER_OBJECT_RENDERER_OBJECT_RENDERER_VTN_COLOR_H_
#define _3D_VIEWER_MODEL_OPENGL_RENDERER_OBJECT_RENDERER_OBJECT_RENDERER_VTN_COLOR_H_
...
class ObjectRendererVTNColor : public ObjectRendererColor {
 public:
  ObjectRendererVTNColor();
  virtual ~ObjectRendererVTNColor();
...
#endif  // _3D_VIEWER_MODEL_OPENGL_RENDERER_OBJECT_RENDERER_OBJECT_RENDERER_VTN_COLOR_H_
